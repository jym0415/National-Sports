...
<article id="bo_v" style="width:<?php echo $width; ?>" class="py-5 my-5 w-75 mx-auto">
    <header>
        <h2 id="bo_v_title" class="py-5 my-5">
    ...
    <section id="bo_v_info" class="w-75 mx-auto">
        <!-- <h2>페이지 정보</h2> -->
	        ...
	        <ul class="btn_bo_user bo_v_com d-flex">
                ...
                <?php if ($admin_href) { ?>
                    ...
                    <li class="position-relative">
                        <button type="button" class="btn_more_opt is_view_btn btn_b01 btn"><i class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">리스트 옵션</span></button>
...
;
    ...
    <section id="bo_v_atc" class="w-75 mx-auto">
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con" class="my-3"><?php echo get_view_thumbnail($view['content']); ?></div>
    ...
    <ul class="bo_v_nb w-75 mx-auto text-left">
        <?php if ($prev_href) { ?><li class="btn_prv"><span class="nb_tit"><i class="fa fa-chevron-up" aria-hidden="true"></i> 이전글</span><a href="<?php echo $prev_href ?>"><?php echo $prev_wr_subject;?></a> <span class="nb_date"></span></li><?php } ?>
        <?php if ($next_href) { ?><li class="btn_next"><span class="nb_tit"><i class="fa fa-chevron-down" aria-hidden="true"></i> 다음글</span><a href="<?php echo $next_href ?>"><?php echo $next_wr_subject;?></a>  <span class="nb_date"></span></li><?php } ?>
    </ul>
    <?php } ?>
