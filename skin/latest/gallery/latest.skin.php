...
<div class="dailyBWrap d-flex align-items-center pb-5">
    ...
    <div class="snsWrap d-flex justify-content-between">
        <div class="left">
            <img src="/joy/theme/basic/img/icon_heart.png" alt="">
            <img src="/joy/theme/basic/img/icon_dm.png" alt="">
            <img src="/joy/theme/basic/img/icon_plain.png" alt="">
        </div>
        <div class="right">
            <img src="/joy/theme/basic/img/icon_save.png" alt="">
        </div>
    </div>
</div>
